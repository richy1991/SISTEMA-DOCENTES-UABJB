...
const PDFPreviewModal = ({ isOpen, onClose, pdfUrl }) => {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-2">
      ...
      <div className="relative bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-4xl h-[96vh] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-slate-50 dark:bg-slate-900/50">
          ...
          <button onClick={onClose} className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 p-2 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700">
        ...
        <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 flex justify-end gap-3">
          ...
          {blobUrl && (
              <a href={blobUrl} download="Fondo_Tiempo.pdf" className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium shadow-lg flex items-center gap-2">
