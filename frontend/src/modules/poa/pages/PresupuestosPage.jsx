...
const PresupuestosPage = () => {
  ...
  return (
  <section style={{ maxWidth: 'calc(100vw - 2rem + 0.5cm)' }} className="flex flex-col items-start flex-1 pt-0 pb-12 px-4 w-full max-w-screen-xl mx-auto">
